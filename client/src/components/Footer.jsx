                    ...
                    <div className="flex flex-col lg:flex-row gap-16 pb-12">
                        <div className="flex-1 max-w-full lg:max-w-100">
                            ...
                            <p className="text-sm leading-7 text-zinc-500 mb-7 max-w-80">
                                Experience the power of AI using QuickAI <br/> Transform your content creation with our suite of premium AI Tools
                    ...
                    <div className="flex flex-col md:flex-row gap-6 md:gap-16 py-9 max-w-6xl">
                        <div className="flex items-start gap-2.5 flex-1">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-zinc-500 leading-relaxed"> 8-137-2-1 , Dhone , Kurnool<br />Andhra Pradesh</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-2.5 flex-1">
                            <div className="size-8 rounded-lg bg-zinc-100 border border-zinc-200 flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-zinc-500 leading-relaxed">+91 (55) 123-4567</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-2.5 flex-1">
                            <div className="size-8 rounded-lg bg-zinc-100 border border-zinc-200 flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-zinc-500 leading-relaxed">admin26@gmail.com</p>
                            </div>
                        </div>
                    </div>

                    <div className="flex flex-col md:flex-row justify-between items-center gap-4 py-4 border-t border-zinc-300">
                        <p className="text-sm text-zinc-500">&copy; {new Date().getFullYear()} PrebuiltUI. All Right Reserved.</p>
